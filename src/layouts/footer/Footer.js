                          ...
                          <div className="social-profiles-wrapper-inner social-profiles-default social-profiles-shape-square">
                            <div className="social-profiles">
                              <ul>
                                <li>
                                  <a
                                    href="https://www.facebook.com/Dr.ReddysLaboratoriesLtd"
                                    title="Facebook"
                                    target="_blank"
                                  >
                                ...
                                <li>
                                  <a
                                    href="https://twitter.com/drreddys"
                                    title="Twitter"
                                    target="_blank"
                                  >
                          ...
                          <Row>
                            <div className="col-12">
                              <div className="footer-content">
                                Dr.Reddy' s Mobile app is Available now. Download it
                                now on your favorite device and indulge in a
                ...
                <Container>
                  <div className="row align-items-center">
                    <Col md={6} className="float-left">
                      <p>
                        {" "}
                        © Copyright 2022 <Link to="#">Dr.Reddy’s</Link> All Rights
                        Reserved.
                      </p>
                    </Col>
