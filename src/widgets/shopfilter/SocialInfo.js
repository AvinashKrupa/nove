            ...
            <div className="social-profiles-wrapper">
                <div className="social-profiles-wrapper-inner social-profiles-default social-profiles-shape-square">
                    <div className="social-profiles">
                        <ul>
                            <li><a href="https://www.facebook.com/Dr.ReddysLaboratoriesLtd" title="Facebook" target="_blank" ><i className="fa fa-facebook" /></a></li>
                            <li><a href="https://twitter.com/drreddys" title="Twitter" target="_blank" ><i className="fa fa-twitter" /></a></li>
