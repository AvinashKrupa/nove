...
import { getSellerName } from "../../actions/Product";
const settings = {
  dots: false,
  infinite: true,
  speed: 500,
...
class PostDetail extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      sold_by: localStorage.getItem("soldbyname"),
    };
  }
  // componentWillMount() {
  //   this.props.getSellerName(this.props.seller_id);
  // }

  componentDidUpdate(prevProps) {
    if (this.props.seller_id !== prevProps.seller_id) {
      this.props.getSellerName(this.props.seller_id);
    }
  }
  ...
  render() {
    ...
    console.log("testing", this.props.seller_id);
    return (
      <section>
              ...
              <div className="product-top-right-inner">
                <div className="summary entry-summary">
                  ...
                  <div className="product_meta">
                    ...
                    <span className="posted_in">
                      <label>Sold By:</label>
                      {/* {localStorage.getItem("soldbyname")
                        ? localStorage.getItem("soldbyname")
                        : ""} */}{" "}
...
const AppMapStateToProps = (state) => {
  return {
    ...
    seller_id: state.productsData.productId,
    seller_name: state.SellerData.seller_Name,
  };
};
