...
class SuccessScreen extends Component {
  ...
  ReadCartItems() {
    this.state.CartItems = JSON.parse(
      localStorage.getItem("FinalCheckoutCartItems")
    );
                ...
                <div className="success-screen">
                      ...
                      <Row>
                        <Col lg={6}>
                          ...
                          <ul className="list-unstyled mb-0">
                            <li>
                              {CommonList[0].profile.firstname}{" "}
                              {CommonList[0].profile.lastname}
                            </li>
                  ...
                  this.state.CartItems.length > 0 ? (
                    <div className="ordered-detail">
                      <h5 className="mb-4 mt-4">Your Ordered Details</h5>
                        ...
                        <table class="table total-table table-borderless mt-4 mb-0">
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td className="text-right">
                                $
                                {this.state.TotalShippingCarge.toLocaleString(
                                  navigator.language,
                                  { minimumFractionDigits: 2 }
                                )}
                              </td>
